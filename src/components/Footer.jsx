...
function Footer() {
  return (
    <div className='flex gap-10 w-full h-screen bg-zinc-900 px-20 py-10'>
        <div className='w-1/2 h-full font-custom1 flex flex-col justify-between leading-none'>
            <div className='Heading'>
                <h1 className='text-[9vw] uppercase -mb-10'>Eye-</h1>
                <h1 className='text-[9vw] uppercase -mb-28'>opening</h1>
            </div>
        ...
        <div className='w-1/2'>
            <div className="Heading font-custom1">
                <h1 className='text-[9vw] uppercase leading-none '>Presentations</h1>
            </div>
            <div className='flex'>
                <div className='w-3/4 font-["Neue_Montreal"]'>
                    <div className="dets ">
                        <a className='block text-xl font-light mb-5' href="#">S :-</a>
                    ...
                    <div className="dets mt-7 mb-7">
                        <a className='block text-xl font-light mb-5' href="#">L :</a>
                        {["202-1965 W 4th Ave","Vancouver, Canada","30 Chukarina St","Lviv, Ukraine"].map((item, index) => (
                            <a key={index} className={`block text-xl font-light ${index === 1 && "mb-5"}`}>{item}</a>
                        ))}
                    </div>
                    <div className="dets">
                        <a className='block text-xl font-light mb-5' href="#">E :</a>
                        <a className='block text-xl font-light underline underline-offset-8' href="#">hello@ochi.design</a>
                    </div>
                    <div className="dets">
                        <a className='mt-14 block text-xl font-light text-zinc-500' href="#">© ochi design 2024. <span className='underline underline-offset-4'>Legal Terms</span></a>
                    </div>
                </div>
                <div className='1/4'>
                    <div className="dets font-['Neue_Montreal'] mt-44">
                        <a className='block text-xl font-light mb-5' href="#">M :</a>
                        {["Home","Services","Our Work","About Us","Insights", "Contact Us"].map((item, index) => (
                            <a key={index} className={`block text-xl font-light`}>{item}</a>
                        ))}
                    </div>
                    <div className="dets">
                        <a className='mt-28 block text-xl font-light text-zinc-500' href="#">Website by Bhavik.</a>
                    </div>
                </div>
            </div>
        </div>
